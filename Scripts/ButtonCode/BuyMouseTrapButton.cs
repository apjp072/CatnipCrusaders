...
public partial class BuyMouseTrapButton : Button
{
    // Variables for mouse trap properties with initial values
    private int mouseTrapCount = 0;
    [Export] private int mouseTrapValue = 1;         // Amount a mouse trap gives you per timeout
    [Export] private int mouseTrapCost = 1;          // Initial cost of a mouse trap
    [Export] private int mouseTrapCostIncrement = 1; // Incremental cost of a mouse trap
    ...
    public void OnMouseTrapTimeout()
    {
