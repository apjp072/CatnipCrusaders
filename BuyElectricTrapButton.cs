...
public partial class BuyElectricTrapButton : Button
{
    // Variables for mouse trap properties
    ...
    [Export] private int initialTimer;           // Initial timer duration for a mouse trap
    ...
    public void onButtonPress()
    {
        ...
        if (score >= currentCost)
        {
            ...
            mouseTrapCostLabel.Text = "$" + (mouseTrapCost + (mouseTrapCount * mouseTrapCostIncrement)).ToString();
